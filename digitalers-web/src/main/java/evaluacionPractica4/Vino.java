...
public class Vino implements EsLiquido, EsAlimento, ConDescuento {
	...
	public String toString() {
		return "Vino{" + "marca=" + marca + ", tipoVino=" + tipoVino + ", grados=" + grados + ", precio=" + precio
				+ "\nvolumen=" + volumen + ", tipoEnvase=" + tipoEnvase + ", caducidad="
				+ caducidad.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + "\ndescuento=" + descuento
				+ ", precio con descuento=" + getPrecioDescuento() + ", calorías=" + getCalorias() + '}';
	}
